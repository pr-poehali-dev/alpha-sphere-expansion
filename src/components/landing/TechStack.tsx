      ...
      <div className="container mx-auto px-4">
        ...
        >
          <p className="max-w-2xl mx-auto">
            Широкий технологический стек позволяет подбирать оптимальные инструменты для каждой задачи.
            Нет избыточных зависимостей — только то, что реально нужно проекту.
          </p>
        </motion.div>
      </div>
    </section>
